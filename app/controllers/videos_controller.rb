class VideosController < ApplicationController
  ...
  def new
      ...
      if !params[:video_type].nil?
        ...
        if @video.video_type == "Movie EPK" || @video.video_type == "Movie Master" || @video.video_type == "TV Special"
 ...
 #   end
  ...
  def destroy
    ...
    if tot_playlists.zero?
      ...
      flash[:notice] = 'Video could not be deleted, video is in use for by playlists'
    	@video_is_deleted = false
    end
